...
export const Calculator: React.FC = () => {
  ...
  return (
    <section className="z-1000 absolute bottom-2 left-4 flex items-center rounded-md bg-fuchsia-800/90 py-0.5 px-2 text-xl leading-tight text-white shadow-xl">
      ...
      <button
        ...
        className="ml-2 inline-flex h-4 w-4 items-center justify-center rounded-full border border-white/40 text-xs text-white/30 hover:text-white"
      >
        &times;
      </button>
    </section>
