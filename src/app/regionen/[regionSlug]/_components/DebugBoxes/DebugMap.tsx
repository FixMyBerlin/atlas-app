...
export const DebugMap = () => {
  ...
  return (
    <div className="group absolute right-[8.5rem] top-3 z-50 max-h-[95%] max-w-[25rem] space-y-0.5 overflow-y-auto rounded bg-pink-300 px-2 py-2 text-[10px] shadow-xl">
      <button
