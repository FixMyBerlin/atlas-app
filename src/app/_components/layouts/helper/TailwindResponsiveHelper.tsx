...
export const TailwindResponsiveHelper = () => {
  ...
  return (
    <a
      className="border-xl fixed bottom-1 left-[calc(100vw/2)] z-10 flex h-5 flex-row items-center space-x-1 rounded bg-pink-300 px-1 text-xs shadow-xl hover:underline print:hidden"
