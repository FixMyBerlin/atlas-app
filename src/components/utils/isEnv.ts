...
export const isProd =
  import.meta.env.PROD && import.meta.env.VITE_NETLIFY_CONTEXT === 'production'

export const isStaging =
  import.meta.env.PROD && import.meta.env.VITE_NETLIFY_CONTEXT === 'staging'

// This uses the fallback to .env.DEV in case the .env.local file is not set up.
export const isDev =
  import.meta.env.DEV || import.meta.env.VITE_NETLIFY_CONTEXT === 'development'
