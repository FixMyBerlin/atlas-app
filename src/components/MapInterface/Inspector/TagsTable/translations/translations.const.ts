...
export const translations: { [key: string]: string } = {
  ...
  'tarmac_bikelanes--category=cyclewayOnHighway_shared': 'Gemeinsamer Fahrstreifen mit Kfz',
  'tarmac_bikelanes--category=cyclewayOnHighway_unspecified': 'Radfahrstreifen oder Schutzstreifen',
  'tarmac_bikelanes--category=cyclewaySeparated': 'Radweg, baulich von der Fahrbahn abgesetzt',
