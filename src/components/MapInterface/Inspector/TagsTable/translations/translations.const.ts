...
export const translations: { [key: string]: string } = {
  ...
  'parkraumParking--orientation=diagonal': 'Parken diagonal zu Straße (45°-60°)',
  'parkraumParking--orientation=no': '(!) Kein Parken',
  'parkraumParking--orientation=parallel': 'Parken parallel zur Straße',
  'parkraumParking--orientation=perpendicular': 'Parken quer zur Straße (~90°)',
  ...
  'parkraumParking--position--key': 'Parkposition',
  'parkraumParking--position=lane': 'Auf der Fahrbahn',
  'parkraumParking--position=half_on_kerb': 'Halb auf dem Bürgersteig',
  'parkraumParking--position=on_kerb': 'Auf dem Bürgersteig',
  ...
  'parkraumParkingStats--d_other_km--key': 'TODO d_other_km',
  'parkraumParkingStats--done_percent--key': 'Stand Erfassung Parkraum',
  'parkraumParkingStats--lane_km--key': 'Summe Straßenlänge',
  'parkraumParkingStats--length_wo_dual_carriageway--key': 'TODO length_wo_dual_carriageway',
  'parkraumParkingStats--street_side_km--key': 'Summe Straßenlänge `street_side`',
  'parkraumParkingStats--sum_km--key': 'TODO Summe km',
