...
export const translations: { [key: string]: string } = {
  ...
  'tarmac_bikelanes--category=cyclewayOnHighway': 'Radfahrstreifen oder Schutzstreifen',
  ...
  'tarmac_bikelanesPresence--LEFTRIGHTSELF=cyclewayOnHighway': 'Radfahrstreifen oder Schutzstreifen',
