...
export const translations: { [key: string]: string } = {
  ...
  'tarmac_bikelanes--category=cycleway_adjoining': 'Radweg (baulich von der Fahrbahn abgesetzt aber straßenbegleitend)',
  ...
  'tarmac_bikelanes--category=footAndCyclewaySegregated_adjoining': 'Getrennter Rad- und Gehweg, straßenbegleitend',
  'tarmac_bikelanes--category=footAndCyclewaySegregated_adjoiningOrIsolated': 'Getrennter Rad- und Gehweg (Straßenbegleitend oder frei geführt; Kategorisierung unklar)',
  'tarmac_bikelanes--category=footAndCyclewaySegregated_isolated': 'Getrennter Rad- und Gehweg, frei geführt',
