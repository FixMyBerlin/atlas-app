...
export const StatusTablePresence: React.FC<Props> = ({ visible, properties }) => {
  ...
  return (
    <section>
      ...
      {is_present === true && (
        <span className="flex gap-1" title="Die Haupt-Dimension dieses Datensatzes wurde erfasst.">
      ...
      {is_present === undefined && (
        <div className="flex gap-1" title="Das System kann keine Angabe machen.">
