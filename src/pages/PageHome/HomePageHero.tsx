  ...
  return (
    <section className="lg:px-8pt-20 mx-auto max-w-7xl px-4 pt-6 text-center sm:px-6 lg:pt-32">
      <h1 className="font-display mx-auto max-w-4xl text-2xl font-bold tracking-tight text-slate-900 sm:text-5xl sm:font-medium md:text-7xl">
        ...
        <span className="text-yellow-500">Radverkehrsplanung</span>. Nachhaltig
        und verifizierbar.
      </h1>
      <p className="mx-auto mt-6 max-w-2xl text-lg tracking-tight text-slate-700">
        Der Radverkehrsatlas unterstützt die kommunale Radverkehrsplanung, indem
      ...
      <p className="mx-auto mt-6 max-w-2xl text-lg tracking-tight text-slate-700">
        ...
        für die Warteliste an, um den Radverkehrsatlas in der Beta-Phase nutzen
        zu können und Benachrichtigungen zu Updates zu bekommen.
      </p>
