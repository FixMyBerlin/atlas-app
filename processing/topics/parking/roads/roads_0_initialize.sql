...
INSERT INTO public.parking_source_regions_roads
SELECT * FROM public.parking_source_germany_roads
WHERE ST_Intersects(
    geom,
    ST_Transform(
...
INSERT INTO public.parking_roads
SELECT * FROM public.parking_source_regions_roads;
