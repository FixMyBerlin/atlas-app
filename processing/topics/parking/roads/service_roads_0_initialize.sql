...
INSERT INTO public.parking_source_regions_service_roads
SELECT * FROM public.parking_source_germany_service_roads
WHERE ST_Intersects(
    geom,
    ST_Transform(
...
INSERT INTO public.parking_service_roads
SELECT * FROM public.parking_source_regions_service_roads;
