...
INSERT INTO public.parking_source_regions_obstacle_points
SELECT * FROM public.parking_source_germany_obstacle_points
WHERE ST_Intersects(
    geom,
    ST_Transform(
...
SELECT * FROM public.parking_source_regions_obstacle_points;
