...
INSERT INTO public.parking_source_regions_kerbs
SELECT * FROM public.parking_source_germany_kerbs
WHERE ST_Intersects(
    geom,
    ST_Transform(
...
INSERT INTO public.parking_kerbs
SELECT * FROM public.parking_source_regions_kerbs;
