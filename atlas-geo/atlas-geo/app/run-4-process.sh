...
echo "\e[1m\e[7m PROCESS – Topic: bikelanes_v1 \e[27m\e[21m"
${OSM2PGSQL_BIN} --create --output=flex --extra-attributes --style=${PROCESS_DIR}bikelanes/bikelanes_v1.lua ${OSM_FILTERED_FILE}
