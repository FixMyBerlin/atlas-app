...
RUN apt update && apt install -y osm2pgsql osmium-tool postgresql-client-15 tzdata wget libpq-dev python3 python3-psycopg2 python3-fastapi python3-uvicorn && apt upgrade -y
# LUA Libaries:
