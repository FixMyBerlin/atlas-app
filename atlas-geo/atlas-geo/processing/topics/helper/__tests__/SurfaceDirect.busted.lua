describe("DeriveSurface", function()
  ...
  it('should return correct surface_source, surface_confidence for tag', function()
  ...
  it('should return correct surface_source, surface_confidence for nil', function()
