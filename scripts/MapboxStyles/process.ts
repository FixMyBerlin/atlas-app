...
const componentFolder = 'src/core/components/MapInterface/mapData/topicsMapData/mapboxStyles'
...
Bun.write(stylesFile, JSON.stringify(mergedSortedGroupAndLayers, undefined, 2))
...
Bun.write(`${componentFolder}/types.ts`, typesFileContent)
